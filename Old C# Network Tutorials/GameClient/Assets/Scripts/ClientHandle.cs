...
public class ClientHandle : MonoBehaviour
{
    public static void Welcome(Packet _packet)
    {
        ...
        // Welcome 패킷을 받았으므로 WelcomeReceived 패킷을 보내기 위해 ClientSend.WelcomeReceived() 실행
        ClientSend.WelcomeReceived();

        // tcp 연결에 사용되는 로컬 포트 전달
    ...
    {
        int _spawerId = _packet.ReadInt();

        GameManager.itemSpawners[_spawerId].ItemSpawned();
    }
